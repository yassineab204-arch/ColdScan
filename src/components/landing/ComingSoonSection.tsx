...
interface ComingSoonSectionProps { onNavigate: (tab: TabType) => void; lang: LanguageType; }

export const ComingSoonSection: React.FC<ComingSoonSectionProps> = ({ onNavigate, lang }) => {
  return (
        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-[2rem] bg-white shadow-[0_32px_70px_-36px_rgba(11,61,46,0.4)] ring-1 ring-ink/6">
            <div className="pointer-events-none absolute inset-0 opacity-[0.5]">
              ...
              <MapPin className="absolute left-[12%] top-[18%] h-6 w-6 text-cold/30" strokeWidth={1.6} />
              <MapPin className="absolute right-[18%] top-[30%] h-5 w-5 text-cold/25" strokeWidth={1.6} />
              <MapPin className="absolute left-[28%] bottom-[22%] h-5 w-5 text-cold/25" strokeWidth={1.6} />

    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-12 sm:h-14 items-center justify-between gap-2">
          ...
          >
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-pine text-cold shadow-[0_6px_16px_-7px_rgba(11,61,46,0.6)] transition-transform duration-200 group-hover:scale-105">
              <Refrigerator className="h-4 w-4" strokeWidth={2.3} />
            </span>
            <span className="flex flex-col items-start leading-none">
              <span className="text-[15px] sm:text-base font-extrabold tracking-tight text-pine">
                ColdScan
              </span>
              <span className="mt-[1px] hidden sm:block text-[7px] font-bold uppercase tracking-[0.24em] text-ink/40">
                Scan · Cook · Save
              </span>
            </span>
          </button>
          ...
          <div className="flex items-center gap-1 sm:gap-1.5">
            ...
            {onSelectLanguage && (
              <div
                className="flex items-center gap-0.5 rounded-full bg-ink/[0.04] p-0.5 ring-1 ring-ink/[0.08]"
                role="group"
                aria-label="Language"
              >
                <Globe className="ml-1 hidden sm:block h-3 w-3 text-ink/40" />
                {(
                  [
                  ...
                  <button
                    ...
                    className={`rounded-full px-1.5 py-0.5 text-[9.5px] font-bold transition-colors sm:px-1.5 sm:text-[10px] ${
                      language === l.id
            ...
            {expiringCount > 0 && activeTab !== 'inventory' && (
              <button
                ...
                className="relative hidden sm:flex items-center gap-1 rounded-full bg-amber-50 px-2.5 py-1.5 text-[11px] font-bold text-amber-700 ring-1 ring-amber-200/80 transition-all hover:bg-amber-100"
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 rounded-full bg-mint px-2.5 py-1.5 text-[11px] font-bold text-pine ring-1 ring-cold/20 transition-all duration-200 hover:bg-mint-deep"
              title="Chat with ColdScan AI"
            >
              <MessageCircle className="h-3.5 w-3.5 text-cold-dark" />
            ...
            >
              <Mic className="h-3.5 w-3.5 text-cold-dark" />
            ...
            <button
              onClick={() => go('scan')}
              className="hidden xl:inline-flex items-center gap-1.5 rounded-full bg-cold px-3.5 py-2 text-xs font-bold text-pine-deep shadow-[0_10px_26px_-10px_rgba(34,197,94,0.8)] transition-all duration-200 hover:bg-cold/90 hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]"
            >
            ...
            <button
              ...
              className={`hidden xl:inline-flex items-center gap-1.5 rounded-full px-3 py-2 text-xs font-bold transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] ${
                activeTab === 'settings'
            ...
            <button
              ...
              aria-label={t('settings', lang)}
              title={t('settings', lang)}
              className={`xl:hidden inline-flex h-8 w-8 items-center justify-center rounded-lg ring-1 transition-colors ${
                activeTab === 'settings'
          ...
          <div className="mx-auto max-w-6xl px-3 py-3 space-y-1">
            {NAV_LINKS.map((link) => {
              ...
              return (
                <button
                  key={link.id}
                  onClick={() => go(link.id)}
                  className={`flex w-full items-center justify-between rounded-lg px-3.5 py-2.5 text-[13.5px] font-semibold transition-colors ${
            ...
            <div className="mt-2 grid grid-cols-2 gap-2">
              <button
                ...
                className="flex items-center justify-center gap-1.5 rounded-lg bg-mint px-3 py-2.5 text-[13px] font-bold text-pine ring-1 ring-cold/20"
              >
                <MessageCircle className="h-3.5 w-3.5 text-cold-dark" />
                {t('askAi', lang)}
              </button>
            ...
            {expiringCount > 0 && activeTab !== 'inventory' && (
              <button
                onClick={() => go('inventory')}
                className="mt-2 flex w-full items-center gap-2 rounded-lg bg-amber-50 px-3.5 py-2.5 text-[13px] font-bold text-amber-800 ring-1 ring-amber-200/80"
              >
                <AlertCircle className="h-3.5 w-3.5 text-amber-500" />
            ...
            {onSelectLanguage && (
              <div className="mt-2 flex items-center gap-1 rounded-lg bg-ink/[0.03] p-1 ring-1 ring-ink/[0.06]">
                <Globe className="ml-1.5 h-3.5 w-3.5 text-ink/40" />
                {(
                  [
                    { id: 'en', label: 'EN' },
                    { id: 'fr', label: 'FR' },
            ...
            <div className="mt-2 flex items-center gap-2">
              <button
                onClick={() => go('settings')}
                className="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-ink/[0.04] px-3 py-2.5 text-[13px] font-semibold text-ink/70"
              >
                <Settings className="h-3.5 w-3.5" />
                {t('settings', lang)}
              </button>
              <button
                onClick={() => go('scan')}
                className="flex flex-[1.6] items-center justify-center gap-1.5 rounded-lg bg-cold px-3 py-2.5 text-[13px] font-bold text-pine-deep shadow-[0_10px_24px_-10px_rgba(34,197,94,0.8)]"
              >
                <Camera className="h-3.5 w-3.5" strokeWidth={2.4} />
                {t('scanMyFridge', lang)}
              </button>
